...
class fashionmnist:
    ...
    def _get_statistics(self):
        if self.tsubame_id:
            train_set = torchvision.datasets.FashionMNIST(root=f'/local/{self.tsubame_id}/data_fashionmnist', train=True, download=True, transform=transforms.ToTensor())
        else:
            train_set = torchvision.datasets.FashionMNIST(root='./data/fashionmnist', train=True, download=True, transform=transforms.ToTensor())
