...
class emnist:
    ...
    def _get_statistics(self):
        if self.tsubame_id:
            train_set = torchvision.datasets.EMNIST(root=f'/local/{self.tsubame_id}/data_emnist', split='balanced', train=True, download=True, transform=transforms.ToTensor())
        else:
            train_set = torchvision.datasets.EMNIST(root='./data/emnist', split='balanced', train=True, download=True, transform=transforms.ToTensor())
